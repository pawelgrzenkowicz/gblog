...
<script lang="ts" setup>
    ...
    const articleContentPicturePath = useRuntimeConfig().public.ARTICLE_CONTENT_PICTURE_PATH
    ...
    class MyUploadAdapter {
        ...
        async upload() {
            ...
            const location = await articleStore.addPicture(formData)
        ...
        abort() {
            throw new Error('Błąd zapisu zdjęcia');
        }
    }
