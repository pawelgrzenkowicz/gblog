...
use App\Infrastructure\Database\Doctrine\SQL\Type\String\SlugType;
...
class SlugTypeTest extends TestCase
{
    ...
    {
        $this->assertSame('slug_type', $this->createInstanceUnderTest()->getName());
    }
    ...
    private function createTitleValueObject(string $value): SlugVO
    {
