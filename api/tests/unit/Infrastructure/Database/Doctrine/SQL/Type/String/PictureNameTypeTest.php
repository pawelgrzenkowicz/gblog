...
use App\Infrastructure\Database\Doctrine\SQL\Type\String\PictureNameType;
use Doctrine\DBAL\Platforms\AbstractPlatform;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

class PictureNameTypeTest extends TestCase
{
    ...
    public function testShouldConvertToDatabaseValue(): void
    {
        ...
        $this->assertEquals(
            ...
            $this->createInstanceUnderTest()->convertToDatabaseValue(
                $this->createPictureNameValueObject($value), $this->abstractPlatform
            )
        );
    }
    ...
    public function testShouldConvertToPHPValue(): void
    {
        ...
        // Then
        $this->assertEquals(
            $this->createPictureNameValueObject($value),
    ...
    {
        $this->assertSame('picture_name_type', $this->createInstanceUnderTest()->getName());
    }

    private function createInstanceUnderTest(): PictureNameType
    {
        return new PictureNameType();
    }

    private function createPictureNameValueObject(string $value): PictureNameVO
    {
