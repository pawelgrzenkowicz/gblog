...
use App\Infrastructure\Database\Doctrine\SQL\Type\Date\CreateDateType;
...
class CreateDateTypeTest extends TestCase
{
    ...
    {
        $this->assertSame('create_date_type', $this->createInstanceUnderTest()->getName());
    }
    ...
    private function createCreateDateValueObject(string $date): CreateDateVO
    {
