<?php  //[STAMP] acbe819f9d522d9951ae1d0e9f482af0
// phpcs:ignoreFile
namespace App\Tests\codeception\_generated;
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\Database::clearDb()
     */
    public function clearDb(string $table): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clearDb', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\Database::loadSqlFile()
     */
    public function loadSqlFile(string $file): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('loadSqlFile', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\Database::mySqlGetConnection()
     */
    public function mySqlGetConnection(): \PDO {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('mySqlGetConnection', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\MongoDatabase::dropDatabase()
     */
    public function dropDatabase(string $collection): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('dropDatabase', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\MongoDatabase::deleteRecordsInDatabase()
     */
    public function deleteRecordsInDatabase(string $collection): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('deleteRecordsInDatabase', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\MongoDatabase::getMongoConnection()
     */
    public function getMongoConnection(): \MongoDB\Client {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getMongoConnection', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\MongoDatabase::insertManyDocuments()
     */
    public function insertManyDocuments(string $collection, array $documents): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('insertManyDocuments', func_get_args()));
    }
     ...
     *
     *
     * @see \App\Tests\codeception\_support\Helper\MongoDatabase::insertFromJsonFile()
     */
    public function insertFromJsonFile(string $collection, string $path): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('insertFromJsonFile', func_get_args()));
    }
    ...
    public function useDatabase(string $dbName): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('useDatabase', func_get_args()));
    }
    ...
    public function seeInCollection(string $collection, array $criteria = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeInCollection', func_get_args()));
    }
    ...
    public function dontSeeInCollection(string $collection, array $criteria = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeInCollection', func_get_args()));
    }
     ...
     */
    public function grabFromCollection(string $collection, array $criteria = []): object|array|null {
    ...
    public function seeElementIsArray(string $collection, array $criteria, string $elementToCheck): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeElementIsArray', func_get_args()));
    }
    ...
    public function seeElementIsObject(string $collection, array $criteria, string $elementToCheck): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeElementIsObject', func_get_args()));
    }
    ...
    public function seeNumElementsInCollection(string $collection, int $expected, array $criteria = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeNumElementsInCollection', func_get_args()));
    }
