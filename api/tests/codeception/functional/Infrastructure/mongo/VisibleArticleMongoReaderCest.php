...
//use App\Infrastructure\Article\Reader\VisibleArticleMongoReader;
...
//
//class VisibleArticleMongoReaderCest
//{
...
//                'limit' => 10,
//                'response' => [
//                    VisibleArticleViewMother::create(
//                        '8c5aec79-60ec-43db-8664-63196a8b8ace',
//                        [
//                            "he" => "jego text",
//                            "she" => "jej text"
//                        ],
...
//                            "alt" => "Dragon-alt",
//                            "extension" => "jpg",
//                            "source" => "command-dragon-ball-db.jpg",
//                        ],
//                        'test-slug-2',
//                        'test-tytuł-2',
//                        0,
...
//        $reader = $I->getClass(VisibleArticleMongoReader::class);
//        $articles = $reader->all(
...
//    {
//        // Given
//        $expected = VisibleArticleViewMother::create(
//            self::EXIST_UUID,
